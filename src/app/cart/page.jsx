        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4">
            <div className="bg-[#fdf6f0] rounded-2xl p-6 sticky top-24 space-y-5">
              ...
              <button className="w-full py-3 bg-[#e8c4a8] text-white rounded-xl hover:bg-[#d4a98a] transition-colors duration-300 text-sm uppercase tracking-widest font-medium cursor-pointer">
                ادامه فرآیند خرید
              </button>
            </div>
          </div>
